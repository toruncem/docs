...
This guide will show you how to download the Athelas Scribe Google Chrome Extension to your Chrome browser.

How to download:

Search for Athelas Scribe in the Chrome Web Store.
Download the extension to your Chrome browser.
Pin the extension to your bookmarks using the push-pin icon.
Click the Athelas icon to open the extension.
