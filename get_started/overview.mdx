...
<Warning>
  ...
  Due to outages on Google Cloud Platform, Athelas Scribe recordings and EHR syncs can be affected. If you're using Athelas Scribe, _do not force close your browser, tab, or webpage_ to avoid any issue with your recording.
