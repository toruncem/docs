...
<Warning>
  ...
  Due to outages with Google Cloud Platform, Athelas Scribe recordings and EHR syncs can be affected. If you're using Athelas Scribe, _do not force close your browser, tab, or webpage _to avoid any issue with your recording. 

  [Read more here](https://dashboard.mintlify.com/commure/commure/editor/main#undefined)
</Warning>
