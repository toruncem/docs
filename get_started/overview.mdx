...
<Warning>
June 12th Update: Due to outages with Google Cloud Platform, Athelas Scribe recordings and EHR syncs can be affected. If you're using Athelas Scribe, do not force close your browser, tab, or webpage to avoid any issue with your recording.
