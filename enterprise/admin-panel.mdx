...
---
Here’s a user-facing documentation draft for the **"Analytics"** section of your Admin Panel based on the screenshots provided:
...
<Frame>
  <img src="/images/admin_analytics.png" />
</Frame>
---
...
Let me know if you'd like this in markdown, Notion, or another format—or if you want to add tooltips/explanations for any specific metric.
Great — here’s a draft for user-facing documentation for the **User Management** section of your Admin Panel, based on the provided screenshots:
...
<Frame>
  <img src="/images/admin_template_manager.png" />
</Frame>
...
<Frame>
  <img src="/images/admin_edit_profile.png" />
</Frame>
---
...
This section empowers admins to quickly onboard users, ensure proper access to templates and facilities, and monitor account activity — all from a centralized dashboard.

---

Let me know if you'd like a separate guide for **template formatting** or **custom rules** setup!
...
* **Configure Custom Formatting** for individual providers using the  *Custom Formatting* link
...
The **Template Library** enables scalable, flexible deployment of documentation formats while ensuring each provider receives the structure they need. It’s ideal for maintaining consistency while supporting personalization at scale.
